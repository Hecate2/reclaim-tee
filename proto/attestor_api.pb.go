...
type ClaimTeeBundleResponse struct {
	...
	Signatures    *ClaimTeeBundleResponse_Signature `protobuf:"bytes,4,opt,name=signatures,proto3" json:"signatures,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ClaimTeeBundleResponse) GetSignatures() *ClaimTeeBundleResponse_Signature {
	if x != nil {
		return x.Signatures
	}
	return nil
...
type ClaimTeeBundleResponse_Signature struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// *
...
func (x *ClaimTeeBundleResponse_Signature) Reset() {
	*x = ClaimTeeBundleResponse_Signature{}
	mi := &file_attestor_api_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ClaimTeeBundleResponse_Signature) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClaimTeeBundleResponse_Signature) ProtoMessage() {}

func (x *ClaimTeeBundleResponse_Signature) ProtoReflect() protoreflect.Message {
	mi := &file_attestor_api_proto_msgTypes[35]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClaimTeeBundleResponse_Signature.ProtoReflect.Descriptor instead.
func (*ClaimTeeBundleResponse_Signature) Descriptor() ([]byte, []int) {
	return file_attestor_api_proto_rawDescGZIP(), []int{14, 0}
}

func (x *ClaimTeeBundleResponse_Signature) GetAttestorAddress() string {
	if x != nil {
...
func (x *ClaimTeeBundleResponse_Signature) GetClaimSignature() []byte {
	if x != nil {
...
const file_attestor_api_proto_rawDesc = "" +
	...
	"\x1aSERVICE_SIGNATURE_TYPE_ETH\x10\x01*\xbb\x01\n" +
	...
	"\x16ATTESTOR_VERSION_3_0_0\x10\x05*\xba\x02\n" +
	"\tErrorCode\x12\x12\n" +
...
var file_attestor_api_proto_goTypes = []any{
	...
	(*ClaimTeeBundleResponse_Signature)(nil),     // 40: teeproto.ClaimTeeBundleResponse.Signature
...
var file_attestor_api_proto_depIdxs = []int32{
	...
	40, // 11: teeproto.ClaimTeeBundleResponse.signatures:type_name -> teeproto.ClaimTeeBundleResponse.Signature
