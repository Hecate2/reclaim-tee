...
func (x *TLSPacketInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *TLSPacketInfo) GetPosition() uint32 {
	if x != nil {
		return x.Position
	}
	return 0
...
func (x *TLSPacketInfo) GetLength() uint32 {
	if x != nil {
		return x.Length
	}
	return 0
...
func (x *TLSPacketInfo) GetNonce() []byte {
	if x != nil {
		return x.Nonce
	}
	return nil
...
type SignedMessage struct {
	...
	ResponsePackets []*TLSPacketInfo `protobuf:"bytes,6,rep,name=response_packets,json=responsePackets,proto3" json:"response_packets,omitempty"`
	ServerAppKey    []byte           `protobuf:"bytes,7,opt,name=server_app_key,json=serverAppKey,proto3" json:"server_app_key,omitempty"`
	CipherSuite     uint32           `protobuf:"varint,8,opt,name=cipher_suite,json=cipherSuite,proto3" json:"cipher_suite,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *SignedMessage) GetResponsePackets() []*TLSPacketInfo {
	if x != nil {
...
func (x *SignedMessage) GetServerAppKey() []byte {
	if x != nil {
		return x.ServerAppKey
	}
	return nil
}

func (x *SignedMessage) GetCipherSuite() uint32 {
	if x != nil {
...
const file_signing_proto_rawDesc = "" +
	...
	"\x12attestation_report\x18\x05 \x01(\v2\x1b.teeproto.AttestationReportR\x11attestationReport\x12B\n" +
	"\x10response_packets\x18\x06 \x03(\v2\x17.teeproto.TLSPacketInfoR\x0fresponsePackets\x12$\n" +
	"\x0eserver_app_key\x18\a \x01(\fR\fserverAppKey\x12!\n" +
	"\fcipher_suite\x18\b \x01(\rR\vcipherSuite*U\n" +
	"\bBodyType\x12\x19\n" +
