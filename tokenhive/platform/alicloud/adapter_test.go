...
func devEpoch() (platform.Epoch, error) {
	return dev.NewEpoch(platform.PlatformAlibabaCloud, "test")
}
...
func TestNewAlibabaCloudFailsOnNonAlibabaHost(t *testing.T) {
	_, err := newAdapter(Config{}, fakeDetect("", false))
	if err == nil {
		t.Fatal("expected an error on a non-Alibaba host")
	}
...
func TestNewAlibabaCloudFailsClosedWithoutAllowUntrusted(t *testing.T) {
...
func TestNewAlibabaCloudAllowUntrustedMintsCloudEpoch(t *testing.T) {
	...
	if id.Platform != platform.PlatformAlibabaCloud {
		t.Fatalf("dev epoch must carry the alicloud platform string, got %q", id.Platform)
	}
...
func TestNewAlibabaCloudRefreshIsNoop(t *testing.T) {
...
func TestPlatformString(t *testing.T) {
	if got := (Verifier{}).Platform(); got != platform.PlatformAlibabaCloud {
